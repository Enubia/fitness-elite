    ...
    <div class="bg-white text-background">
        <div class="container py-16">
            ...
            <section class="mt-10">
                ...
                <p class="mt-4">
                    Wenn Sie allgemeine Fragen zu den Diensten oder den von uns über Sie erfassten Daten und deren Verwendung haben, kontaktieren Sie uns bitte unter: <a href="mailto:fitness-elite.eu@hotmail.com">fitness-elite.eu[at]hotmail.com</a>
                </p>
            </section>
        </div>
    </div>
